...
from .serializers import UserSerializer,OrderSerializer,ProductSerializer,ContactSerializer,CommentSerializer,BlogSerializer,TeamSerializer,BannerSerializer,ReviewSerializer,SliderSerializer,BlogSidebarSerializer,PaymentSerializer
