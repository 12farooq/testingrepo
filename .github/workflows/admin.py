...
from .models import Categories, Products, ProductAttributes, ProductVariations, Payment, Customers, Orders, OrderItems, Shipments, ProductReviews,Tag,ProductImage,Size,Contact,Blog,Comment,Team,Banner,Slider,BlogSideBar
...
class PaymentsAdmin(admin.ModelAdmin): 
    list_display = ('payment_id', 'order', 'payment_method', 'payment_amount')
