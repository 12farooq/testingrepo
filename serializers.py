...
from .models import Products,Customers,OrderItems,Orders,Size,ProductImage,ProductVariations,Tag,Categories,ProductReviews,Contact,Comment,Blog,Team,Banner,Slider,BlogSideBar,Payment
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    def validate_payment_id(self, value):
        if any(char.isspace() for char in value):
            raise serializers.ValidationError("payment_id should not contain spaces.")
        return value
